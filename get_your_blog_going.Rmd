...
- In `content/authors/admin/index.md`, update with your info & contact information
- Update your picture: 
...
- Create a new R Markdown document, knit and save as index.Rmd and index.html in the my_test_project folder you just created 
- `serve_site()` and see that your test project now shows up!
- Drop an image named `featured.jpg` to the folder to have a project image

### Another option: New post add-ins

- Create a new folder in `content/project` called cool_project
- In the top bar of RStudio, click on Addins > New Post
- Add a post title
- Change the subdirectory to project/cool_project
- Update file type to .Rmd
- Change the name to 'index.Rmd'
- Add some tags (comma to separate)
- Create the new post
- Update the .Rmd, knit & serve site - check it out!
- Drop image called 'featured.jpg' into the cool_project folder, see that it appears
